...
export function themeVar<T extends keyof Theme>(name: T): string {
...
export const themeSubspaced: Theme = {
	...themeLight,
	id: "subspaced",
	name: "Subspaced",
	scheme: "light dark",
...
export function makeCssForTheme(theme: Theme): string {
	let result = "";

	result += `color-scheme: ${theme.scheme};\n`;

	for (const [key, value] of Object.entries(theme)) {
		if (key === "name" || key === "id" || key === "scheme") continue;
...
export function getCurrentTheme(): Theme {
	...
	// return theme;
	return themeSubspaced;
}

export function GlobalCss(props: { extraCss: Solid.Accessor<string>[] }) {
