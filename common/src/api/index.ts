...
export namespace Error {
	...
	export const studylistInvalidName: ErrorType = {
		statusCode: 400,
		statusMessage: "invalid name for study list",
	};

	export const userStudylistCount: ErrorType = {
		statusCode: 400,
		statusMessage:
			"user has reached their maximum number of study lists created",
	};

	export const studylistEditorCount: ErrorType = {
		statusCode: 400,
		statusMessage:
			"study list has reached its maximum capacity for editors",
	};

	export const studylistCapacity: ErrorType = {
		statusCode: 400,
		statusMessage: "study list has reached its maximum capacity for words",
	};
}
...
export function userIsSystem(user: MaybeUser) {
	...
	if (!user.tags?.some((tag) => tag === "system")) return false;
...
export namespace Login {
	...
	export const urlFrontendFake = `/login_fake_page`;

	export const urlFakeMatchUserId = "userId";

	export const urlFake = `/login_fake/:${urlFakeMatchUserId}`;
...
export namespace Analytics {
	...
	export type Id = "search" | "studylistId" | "studylistWordAdd";
